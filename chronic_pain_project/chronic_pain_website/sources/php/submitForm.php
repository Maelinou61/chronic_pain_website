...
try {
    ...
    $ideas_about_pain = $_POST['ideas_about_pain'];
    $concerns_about_pain = $_POST['concerns_about_pain'];
    $expectations = $_POST['expectations'];
    $closing_thoughts = $_POST['closing_thoughts'];
    ...
    ideas_about_pain, concerns_about_pain, expectations, closing_thoughts, ID_pain_location, ID_vertebrae)
