...
try {
    ...
    $insertStatement = $db->prepare("INSERT INTO userinformation (first_name, last_name, birthdate, email, user_role, password)
        VALUES (:first_name, :last_name, :birthday, :email, :user_role, :password)");
