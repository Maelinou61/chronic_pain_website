document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchQuestion(response = '', previousQuestion = '') {
        ...
        let url = `sources/php/pain_decision_tree/initial_decision_trunk.php?first_name=${encodeURIComponent(firstName)}&last_name=${encodeURIComponent(lastName)}&date=${encodeURIComponent(date)}`;
        if (response) {
