...
document.getElementById("questions").addEventListener('submit', function(event){
    ...
    var formFields = document.querySelectorAll('#questions input, #questions select, #questions textarea');
    var isEmpty = false;
    ...
    html2canvas(document.querySelector("#section2"), ).then(canvas => {
        ...
        // Log du contenu du canvas dans la console
        console.log("Contenu du canvas en base64 :", base64Image);

        // Envoyer le FormData via une requête AJAX
