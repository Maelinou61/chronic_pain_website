...
try {
    ...
    // Assign a default value to pain_location if it is not set
    $pain_location = isset($_POST['pain_location']) ? $_POST['pain_location'] : 0;
    ...
    VALUES (:user_id, :pain_beginning, :pain_intensity, :pattern, :distress, :interference, IFNULL(:pain_location, 0), :cancer, :cancer_treatment, :begin_after_surgery, :worse_after_surgery, :area_surgery, :spread_pain_surgery)");
