...
function getUserData($firstName, $lastName, $date) {
    try {
        // Connection
        ...
        $query = "SELECT p.id, p.pain_intensity, p.pain_related_distress, p.pain_related_interference,
                         p.ideas_about_pain, p.concerns_about_pain, p.expectations, p.closing_thoughts, p.bodychart_image,
                  ...
                  WHERE ui.first_name = :firstName AND ui.last_name = :lastName AND p.date = :date";
