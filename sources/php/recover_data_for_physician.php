...
function getUserData($firstName, $lastName) {
    try {
        ...
        $query = "SELECT p.id, p.pain_intensity, p.pain_related_distress, p.pain_related_interference,
                         p.ideas_about_pain, p.concerns_about_pain, p.expectations, p.closing_thoughts, p.bodychart_image, p.date,
                  ...
                  WHERE ui.first_name = :firstName AND ui.last_name = :lastName";
